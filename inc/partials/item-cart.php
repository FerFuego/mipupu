<tr>
    <td class="shoping__cart__item">
        <div class="d-flex">
                <img src="<?php echo Productos::getImage( $item->CodProducto, $item->Id_Producto ); ?>" width="60px">
        ...
        <td class="shoping__cart__quantity">
            <div class="quantity">
                <div class="pro-qty">
                    <input type="text" name="cant" id="cant_<?php echo $item->Auto; ?>" value="<?php echo $item->Cantidad; ?>">
                </div>
            </div>
        </td>
