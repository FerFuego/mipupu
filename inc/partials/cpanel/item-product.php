<tr id="item_prod_<?php echo $product->Id_Producto; ?>">
    ...
    <td class="shoping__cart__item__update text-center">
        <span onclick="getProddata(this);" data-prod="<?php echo $product->CodProducto; ?>" data-toggle="modal"
            data-target="#productModal" class="icon_pencil-edit" title="Editar"></span>
    </td>
