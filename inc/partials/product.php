...
<div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
    <div class="product__item">
        <a href="detalle.php?id=<?php echo $product->CodProducto; ?>" class="product__item__pic set-bg" data-setbg="<?php echo Productos::getImage( $product->CodProducto ); ?>">
        ...
        <div class="product__item__text">
            ...
            <?php if ($general->showPrices()): ?>
                <p class="text-danger"><?php echo 'Precio Lista: <strong>$ '. Polirubro::checkUserCapabilities( $prod ) . '</strong>'; ?></p>
            <?php endif; ?>
            ...
            <?php if ($general->showLoginPrices()): ?>
                <form class="js-form-cart">
                    ...
                    <input type="hidden" name="price_product" value="<?php echo Polirubro::checkUserCapabilities( $prod ); ?>">
                    <div class="d-flex">
